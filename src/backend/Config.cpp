...
{
	auto textFont = QFont(QStringLiteral("Times"), loadToolFontSize(Tools::Text), QFont::Bold);
	auto numberFont = QFont(QStringLiteral("Helvetica"), loadToolFontSize(Tools::Number), QFont::Bold);
